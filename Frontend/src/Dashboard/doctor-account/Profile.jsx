...
const Profile = ({ doctorData }) => {
  ...
  const handleQualificationChange = (event, index) => {
    handleQualificationChangeFunc("qualifications", index, event);
  };
  ...
  const handleExperienceChange = (event, index) => {
    handleQualificationChangeFunc("experiences", index, event);
  };
  ...
  const handleTimeSlotChange = (event, index) => {
    handleQualificationChangeFunc("timeSlots", index, event);
  };
        ...
        <div className="mb-5">
          ...
          {formData.experiences.map((item, index) => (
            <div key={index} className="mb-5">
              ...
              <button
                onClickCapture={(e) => deleteExperience(e, index)}
                className="bg-red-600 p-2 rounded-full text-white text-[18px] mt-2 mb-[30px] cursor-pointer"
              >
                <AiOutlineDelete />
              </button>
